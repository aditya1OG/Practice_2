    ...
    return (
        <div className='flex items-center h-screen justify-around flex-col lg:flex-row border-b-2 border-b-black'>
            <div className='flex flex-col items-center justify-center w-[50%] border-r-2 h-[100vh] border-r-black'>
                ...
                <p className='text-[18px] mb-6 w-[70%] text-center'>Welcome to my front-end developer portfolio. I'm a passionate and aspiring front-end developer showcasing my projects and dedication to creating engaging web experiences.</p>
